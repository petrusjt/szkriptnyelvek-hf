...
def front_back(a, b):
    a_kozep_index = len(a) // 2
    b_kozep_index = len(b) // 2
    if len(a) % 2 == 0:
        a_eleje = a[:a_kozep_index]
        a_vege = a[a_kozep_index:]
    else:
        a_eleje = a[:a_kozep_index + 1]
        a_vege = a[a_kozep_index + 1:]

    if len(b) % 2 == 0:
        b_eleje = b[:b_kozep_index]
        b_vege = b[b_kozep_index:]
    else:
        b_eleje = b[:b_kozep_index + 1]
        b_vege = b[b_kozep_index + 1:]
