...
def main():
    eredmeny = TEXT.replace('3', 'E')
    eredmeny = eredmeny.replace('4', 'A')
    eredmeny = eredmeny.replace('7', 'T')
    eredmeny = eredmeny.replace('0', 'O')
    eredmeny = eredmeny.replace('5', 'S')
    eredmeny = eredmeny.replace('1', 'I')
    print(eredmeny)
